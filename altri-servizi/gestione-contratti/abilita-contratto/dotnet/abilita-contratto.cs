...
namespace XPay
{
    class SampleXPayRequest
    {
        static void Main(string[] args)
        {
            ...
            // URL + URI
            string requestUrl = "https://int-ecommerce.cartasi.it/" + "ecomm/api/contratti/abilitaContratto";
            ...
            string numContratto = "<NUMERO CONTRATTO>"; // Numero del contratto da abilitare
