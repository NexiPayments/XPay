...
if ($connection) {
    ...
    $requestURI = "ecomm/api/contratti/disabilitaContratto"; // URI
    ...
    $numeroContratto = 'scf23fc23'; // Numero del contratto da disabilitare
    $timeStamp = (time()) * 1000;

    // Calcolo MAC
    $mac = sha1('apiKey=' . $apiKey . 'numeroContratto=' . $numeroContratto . "timeStamp=" . $timeStamp . $chiaveSegreta);
