...
if ($connection) {
    ...
    $requestURI = "ecomm/api/cfpan/rimuovi"; // URI
    ...
    $gruppo = '<codiceGruppo>'; // Codice gruppo fornito da CartaSi
    $timeStamp = (time()) * 1000;

    // Calcolo MAC
    $mac = sha1('apiKey=' . $apiKey . 'codiceFiscale=' . $codiceFiscale . 'hashPan=' . $hashPan . "timeStamp=" . $timeStamp . $chiaveSegreta);
