...
if ($connection) {
    ...
    $requestURI = "ecomm/api/blacklist/controlla"; // URI
    ...
    // Calcolo MAC
    $mac = sha1('apiKey=' . $apiKey . 'tipo=' . $tipo . 'valore=' . $valore . 'timeStamp=' . $timeStamp . $chiaveSegreta);
