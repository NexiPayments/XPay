...
namespace XPay
{
    class SampleXPayRequest
    {
        static void Main(string[] args)
        {
            ...
            // URL + URI
            string requestUrl = "https://int-ecommerce.nexi.it/" + "ecomm/api/bo/ReportPaymail";
            ...
            // Calcolo MAC
            string mac = HashMac("apiKey=" + apiKey + "timeStamp=" + timeStamp + chiaveSegreta);

            // Parametri di invio
            var requestParams = new Dictionary<string, string>();
            requestParams["apiKey"] = apiKey;<linkCreatiDal>
            requestParams["linkCreatiDal"] = '01/01/2019';</linkCreatiDal><linkCreatiAl>
            requestParams["linkCreatiAl"] = '31/01/2019';</linkCreatiAl>
