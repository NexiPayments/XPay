...
<html>
    ...
    <head>
        ...
        <script type='text/javascript'>
            ...
            window.addEventListener('load', function () {
                ...
                document.getElementById('pagaBtn').addEventListener("click", function () {
    ...
    <body>
        ...
        <form action="/build/pagamento_semplice.php" name="payment-form" id="payment-form" method="POST">
