...
public class esito {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if ("OK".equals(paramFromRequest.get("esito"))) {
      ...
      System.out.println("dccRate = " + paramFromRequest.get("dccRate"));
      System.out.println("dccAmount = " + paramFromRequest.get("dccAmount"));
      System.out.println("dccCurrency = " + paramFromRequest.get("dccCurrency"));
      System.out.println("dccState = " + paramFromRequest.get("dccState"));
    } else {
