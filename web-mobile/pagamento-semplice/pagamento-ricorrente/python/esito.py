...
# Controllo che si siano tutti i parametri di ritorno obbligatori per calcolare il MAC
...
if macCalculated != param_from_request['mac']:
    raise ValueError('Wrrore MAC: ' + macCalculated + ' non corrisponde a ' + param_from_request['mac'])
