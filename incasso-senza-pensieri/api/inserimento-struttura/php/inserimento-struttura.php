...
// Incasso senza Pensieri - Censisci nuova struttura
...
if ($connection) {
    ...
    $requestURI = "ecomm/api/vas/ig/censisciStruttura"; // URI
    ...
    $codice = "struttura1";
    $descrizioneInterna = "Struttura 1";
    $descrizionePaginaCassa = "Struttura 1";
    $email = "test@test.it";
    $telefono = "333333333";
    $timeStamp = (time()) * 1000;
    ...
    $parametri = array(
        ...
        'struttura' => array(
            ...
            'codice' => $codice,
            'descrizioneInterna' => $descrizioneInterna,
            'descrizionePaginaCassa' => $descrizionePaginaCassa,
            'email' => $email,
            'telefono' => $telefono,
            'defaultGarantita' => array(
                'templateGarantita' => "ORA",
                'oreCancellazioneGarantita' => "24",           
            ), 
        ),    
        'timeStamp' => $timeStamp,
        'mac' => $mac
